...
const DEMO_EMAILS: Email[] = [
  {
    ...
    preview: 'Hey team, I wanted to discuss the critical bugs we found...',
    time: '08:40 AM',
    unread: true,
    starred: false,
    hasAttachment: false,
  ...
  },
  {
    ...
    sender: 'Ross Geller',
    senderAvatar: 'RG',
    subject: 'Dessert soufflé tootsie roll soufflé carrot cake',
    preview: 'The meeting notes from yesterday are ready for review...',
    time: '10:12 AM',
    unread: true,
    starred: false,
    hasAttachment: true,
  ...
  },
  {
    ...
    senderAvatar: 'BS',
    subject: 'Soufflé apple pie caramels soufflé tiramisu',
    preview: 'I have attached the documents you requested last week...',
    time: '12:44 AM',
    unread: false,
    starred: false,
    hasAttachment: true,
  ...
  },
  {
    ...
    senderAvatar: 'PB',
    subject: 'Tart croissant jujubes gummies macaroon',
    preview: 'Looking forward to our collaboration on the new project...',
    time: 'Yesterday',
    unread: false,
    starred: true,
    hasAttachment: false,
