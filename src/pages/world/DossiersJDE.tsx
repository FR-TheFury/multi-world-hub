...
import { Search, FileText, Plus, Filter, Download, MoreHorizontal, Eye, Calendar, Mail, BarChart3, Scale } from 'lucide-react';
...
const DossiersJDE = () => {
  ...
  const fetchWorldAndDossiers = async () => {
    try {
      ...
      toast.error('Erreur lors du chargement des dossiers JDE');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-100/60 via-background to-red-100/40 dark:from-red-950/30 dark:via-background dark:to-red-950/20 p-6">
